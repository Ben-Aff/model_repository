...
auto_scale_lr = dict(enable=False, base_batch_size=2*batchsize)
...
vis_backends = [
    ...
    dict(type='WandbVisBackend',
        init_kwargs=dict(  project='beari',
            entity='r770529885',
            name='rtmdetL_baseline_1128__500',
            tags=[  'A5000',  'num1', 'baseline', 'rtmdet',  ],)),]
