...
def labelme2yolov2Seg(jsonfilePath="C:/Users/Administrator/Desktop/data-source/kk-coco/labels/train-coco",
                      resultDirPath="C:/Users/Administrator/Desktop/data-source/kk-coco/labels/train",
                      classList=["Polygon", "Line"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = "C:/Users/Administrator/Desktop/data-source/kk-coco/labels/val-coco"  # 要转换的json文件所在目录
    resultDirPath = "C:/Users/Administrator/Desktop/data-source/kk-coco/labels/val"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["1", "2"])#json中的类别