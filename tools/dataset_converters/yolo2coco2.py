...
def addAnnoItem(object_name, image_id, category_id, bbox):
    ...
    annotation_item['category_id'] = category_id + 1
    annotation_id += 1
...
if __name__ == '__main__':
    ...
    参数说明：
        ...
        json_name:json文件名字
    """
    anno_path = '/home/renweilun/project/mmdetection/data/NEU/NEU-DEF/labels/train'
    save_path = '/home/renweilun/project/mmdetection/data/NEU/NEU-DEF'
    image_path = '/home/renweilun/project/mmdetection/data/NEU/NEU-DEF/images/train'
