...
def parse_args():
    ...
    parser.add_argument('--config',default='/Users/ferraari/project/mmdetection/mmpretrain/configs/clip/vit-base-p16_pt-64xb64_in1k-384px.py', help='test config file path')
    parser.add_argument('checkpoint',default='/Users/ferraari/project/mmdetection/projects/CLIP/Pretrain/clip-vit-base-p16_openai-pre_3rdparty_in1k-384px_20221220-eb012e87.pth', help='checkpoint file')
    parser.add_argument('--work-dir',default='/Users/ferraari/project/mmdetection/projects/CLIP/office_test',help='the directory to save the file containing evaluation metrics')
    parser.add_argument('--out',default='/Users/ferraari/project/mmdetection/projects/CLIP/office_test', help='the file to output results.')
    parser.add_argument(
        '--out-item',
